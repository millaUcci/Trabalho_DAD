...
config.addEventListener("click", () => {
  ...
  btnResetar.addEventListener('click',()=>{
    let continuar = window.confirm("Deseja realmente resetar? Isso apagará: seu histórico de exercícios concluidos, seu save e o modo do jogo ")
    if (continuar){
...
capituloQuatro.addEventListener("click", () => {
  ...
  //criando exercícios
  if (save == "ca4-ex1") {
    criarExercicio("ca4-ex1","Deletando moradores", true);
    continuarExercicio = true;
  } else {
    criarExercicio("ca4-ex1","Deletando moradores", false);
  }
